                     ...
                     <div class="row">
                       ...
                       <c:if test="${feeFormBean.monthlyFeeList.size() > 0  }">
                        <div class="fee-selction col s12 m12">
	                      ...
	                      <div class="input-field col s12 m3 col-fee">
	                         ...
	                         <div class="input-field col s12 m3">
	                            <form:input placeholder="Discount" id="mfdis_${status.index}" path="monthlyFeeList[${status.index}].discount"  class="validate disc"  onkeypress="return onlyNumbers(event,this);" onblur="setPaidAmount('m',this)" />
	                         </div>
	                         <div class="input-field col s12 m3">
		                         ...
		                         <c:choose>
		                         	...
		                         	<div class="row">
				                         ...
				                         <div class="input-field col s12 m3">
		                         		 ...
		                         		 <div class="input-field col s12 m3">
		                             		<form:input placeholder="Discount" id="qfdis_${status.index}" path="quarterlyFeeList[${status.index}].discount"  class="validate disc"  onkeypress="return onlyNumbers(event,this);" onblur="setPaidAmount('q',this)" />
                         ...
                         <c:forEach items="${feeFormBean.halfyearlyFeeList}" var="feeDto" varStatus="status">
                         	<form:hidden path="halfyearlyFeeList[${status.index}].id"  />
	                          ...
	                          <c:otherwise>
		                         ...
		                         <div class="input-field col s12 m2">
		                           <form:input placeholder="Discount" id="hfdis_${status.index}" path="halfyearlyFeeList[${status.index}].discount"  class="validate disc"  onkeypress="return onlyNumbers(event,this);" onblur="setPaidAmount('h',this)" />
                      ...
                      <div class="fee-selction col s12 m12">
                       <c:forEach items="${feeFormBean.anualFeeList}" var="feeDto" varStatus="status">
	                        ...
	                        <c:choose>
	                          ...
	                          <c:otherwise>
				                        <div class="col s12 m3 col-fee">
				                         ...
				                         <div class="input-field col s12 m3">
				                            <form:input placeholder="Discount" id="afdis_${status.index}" path="anualFeeList[${status.index}].discount"   onkeypress="return onlyNumbers(event,this);" class="validate disc" onblur="setPaidAmount('a',this)" />
                         ...
                         <div class="input-field col s12 m3">
                            <form:input path="totalDiscAmt" placeholder="Discount" type="number" readonly="true" class="validate"/>
