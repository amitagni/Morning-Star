...
.search-c{
   ...
   <body class="dashboard-body">
    ...
    <div class="myimage"  style="background-image: url({somedynamicimageurl})"><img src="" id="stImage" /></div>
</div>
                           </div>
                           ...
                           <div class="col s12 m12" id="stDetails" >
                              ...
                              <select class="error browser-default" id="crole" name="crole" onchange="openSelOption(this);">
                                 ...
                                 <option value="1">Manage Fee</option>
                                 <option value="2">Manage Acadamics</option>
                                 <option value="3">Manage Profile</option>
                              </select>
